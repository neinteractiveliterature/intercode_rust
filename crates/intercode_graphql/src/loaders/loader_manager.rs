...
pub struct LoaderManager {
  ...
  pub cms_navigation_item_section:
    DataLoader<EntityLinkLoader<CmsNavigationItemToCmsNavigationSection>>,
  pub convention_staff_positions: DataLoader<EntityLinkLoader<ConventionToStaffPositions>>,
  ...
  pub event_category_event_form: DataLoader<EntityLinkLoader<EventCategoryToEventForm>>,
  pub event_category_event_proposal_form:
    DataLoader<EntityLinkLoader<EventCategoryToEventProposalForm>>,
  pub event_provided_tickets: DataLoader<EntityLinkLoader<EventToProvidedTickets>>,
  ...
  pub form_form_items: DataLoader<EntityLinkLoader<FormToFormItems>>,
  ...
  pub signup_request_replace_signup: DataLoader<EntityLinkLoader<SignupRequestToReplaceSignup>>,
  pub signup_request_result_signup: DataLoader<EntityLinkLoader<SignupRequestToResultSignup>>,
  pub staff_position_user_con_profiles:
    DataLoader<EntityLinkLoader<StaffPositionToUserConProfiles>>,
  ...
  pub ticket_provided_by_event: DataLoader<EntityLinkLoader<TicketToProvidedByEvent>>,
  pub user_con_profile_staff_positions:
    DataLoader<EntityLinkLoader<UserConProfileToStaffPositions>>,
...
impl LoaderManager {
  pub fn new(db: ConnectionWrapper) -> Self {
    ...
    LoaderManager {
      ...
      .delay(delay_millis),
      event_provided_tickets: DataLoader::new(
        EntityLinkLoader::new(db.clone(), EventToProvidedTickets, events::PrimaryKey::Id),
        tokio::spawn,
      )
      .delay(delay_millis),
      ...
      .delay(delay_millis),
      ticket_provided_by_event: DataLoader::new(
        EntityLinkLoader::new(db.clone(), TicketToProvidedByEvent, tickets::PrimaryKey::Id),
        tokio::spawn,
      )
      .delay(delay_millis),
